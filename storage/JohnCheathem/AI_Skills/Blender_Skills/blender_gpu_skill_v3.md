...
**Verified by:** Two diagnostic runs + working addon (phacelle_erosion_v2.py) + Shakespeare RNN training session  
...
*Version 3.0 — v2.0 base + Shakespeare RNN training session (2026-04-02)*  
*Adds: 2D output texture confirmed broken, single-row matrix packing, multiple samplers, accumulation loops, local_group_size(64,1,1), explicit reshape, sanity-check pattern*  

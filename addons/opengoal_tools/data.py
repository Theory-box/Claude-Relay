...
ENTITY_DEFS = {
    ...
    "baby-spider":      {"label":"Baby Spider",          "cat":"Enemies",   "tpage_group":"Maincave", "ag":"baby-spider-ag.go",       "nav_safe":False, "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"nav-enemy",        "color":(0.5,0.2,0.1,1.0), "shape":"SPHERE", "glb": "levels/maincave/baby-spider-lod0.glb"},
    ...
    # Maincave group
    "mother-spider":    {"label":"Mother Spider",        "cat":"Enemies",   "tpage_group":"Maincave", "ag":"mother-spider-ag.go",     "nav_safe":True,  "needs_path":True,  "needs_pathb":False, "is_prop":False, "ai_type":"process-drawable", "color":(0.6,0.2,0.1,1.0), "shape":"SPHERE", "glb": "levels/maincave/mother-spider-lod0.glb"},
    ...
    "dark-crystal":     {"label":"Dark Crystal",         "cat":"Enemies",   "tpage_group":"Maincave", "ag":"dark-crystal-ag.go",      "nav_safe":True,  "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"process-drawable", "color":(0.4,0.0,0.6,1.0), "shape":"SPHERE", "glb": "levels/maincave/dark-crystal-lod0.glb"},
    ...
    "ram":              {"label":"Ram",                  "cat":"Enemies",   "tpage_group":"Village1", "ag":"ram-ag.go",               "nav_safe":True,  "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"process-drawable", "color":(0.7,0.4,0.2,1.0), "shape":"SPHERE", "glb": "levels/village1/ram-lod0.glb"},
    ...
    "flutflut":         {"label":"Flut Flut",            "cat":"NPCs",      "ag":"flutflut-ag.go",          "nav_safe":True,  "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"process-drawable", "color":(0.4,0.7,1.0,1.0), "shape":"SPHERE", "glb": "levels/swamp/flutflut-lod0.glb"},
    "mayor":            {"label":"Mayor",                "cat":"NPCs",      "ag":"mayor-ag.go",             "nav_safe":True,  "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"process-drawable", "color":(0.9,0.7,0.2,1.0), "shape":"SPHERE", "glb": "levels/village1/mayor-lod0.glb"},
    ...
    "orb-cache-top":    {"label":"Orb Cache",            "cat":"Pickups",   "ag":"orb-cache-top-ag.go",     "nav_safe":True,  "color":(0.9,0.7,0.1,1.0), "shape":"CUBE", "glb": "levels/common/orb-cache-top-lod0.glb"},
    "powercellalt":     {"label":"Power Cell (alt)",     "cat":"Pickups",   "ag":"powercellalt-ag.go",      "nav_safe":True,  "color":(1.0,0.85,0.0,1.0),"shape":"ARROWS", "glb": "levels/common/powercellalt-lod0.glb"},
    ...
    "plat":             {"label":"Floating Platform",    "cat":"Platforms", "ag":"plat-ag.go",              "nav_safe":True,  "needs_path":False, "needs_sync":True,  "needs_notice_dist":False, "color":(0.5,0.5,0.8,1.0), "shape":"CUBE", "glb": "levels/common/plat-lod0.glb"},
    "plat-eco":         {"label":"Eco Platform",         "cat":"Platforms", "ag":"plat-eco-ag.go",          "nav_safe":True,  "needs_path":False, "needs_sync":True,  "needs_notice_dist":True,  "color":(0.3,0.7,0.9,1.0), "shape":"CUBE", "glb": "levels/common/plat-eco-lod0.glb"},
    "plat-button":      {"label":"Button Platform",      "cat":"Platforms", "ag":"plat-button-ag.go",       "nav_safe":True,  "needs_path":True,  "needs_sync":False, "needs_notice_dist":False, "color":(0.6,0.6,0.7,1.0), "shape":"CUBE", "glb": "levels/common/plat-button-geo.glb"},
    "plat-flip":        {"label":"Flip Platform",        "cat":"Platforms", "ag":"plat-flip-ag.go",         "nav_safe":True,  "needs_path":False, "needs_sync":False, "needs_notice_dist":False, "color":(0.5,0.5,0.7,1.0), "shape":"CUBE", "glb": "levels/common/plat-flip-geo.glb"},
    "wall-plat":        {"label":"Wall Platform",        "cat":"Platforms", "ag":"wall-plat-ag.go",         "nav_safe":True,  "needs_path":False, "needs_sync":False, "needs_notice_dist":False, "color":(0.4,0.5,0.7,1.0), "shape":"CUBE", "glb": "levels/common/wall-plat-lod0.glb"},
    "balance-plat":     {"label":"Balance Platform",     "cat":"Platforms", "ag":"balance-plat-ag.go",      "nav_safe":True,  "needs_path":False, "needs_sync":False, "needs_notice_dist":False, "color":(0.5,0.6,0.8,1.0), "shape":"CUBE", "glb": "levels/common/balance-plat-lod0.glb"},
    "teetertotter":     {"label":"Teeter Totter",        "cat":"Platforms", "ag":"teetertotter-ag.go",      "nav_safe":True,  "needs_path":False, "needs_sync":False, "needs_notice_dist":False, "color":(0.6,0.5,0.4,1.0), "shape":"CUBE", "glb": "levels/common/teetertotter-lod0.glb"},
    "side-to-side-plat":{"label":"Side-to-Side Plat",   "cat":"Platforms", "ag":"side-to-side-plat-ag.go", "nav_safe":True,  "needs_path":False, "needs_sync":True,  "needs_notice_dist":False, "color":(0.4,0.5,0.8,1.0), "shape":"CUBE", "glb": "levels/common/side-to-side-plat-lod0.glb"},
    "wedge-plat":       {"label":"Wedge Platform",       "cat":"Platforms", "ag":"wedge-plat-ag.go",        "nav_safe":True,  "needs_path":False, "needs_sync":False, "needs_notice_dist":False, "color":(0.5,0.5,0.7,1.0), "shape":"CUBE", "glb": "levels/common/wedge-plat-lod0.glb"},
    "tar-plat":         {"label":"Tar Platform",         "cat":"Platforms", "ag":"tar-plat-ag.go",          "nav_safe":True,  "needs_path":False, "needs_sync":False, "needs_notice_dist":False, "color":(0.2,0.2,0.2,1.0), "shape":"CUBE", "glb": "levels/common/tar-plat-lod0.glb"},
    "revcycle":         {"label":"Rotating Platform",    "cat":"Platforms", "ag":"revcycle-ag.go",          "nav_safe":True,  "needs_path":False, "needs_sync":False, "needs_notice_dist":False, "color":(0.6,0.4,0.6,1.0), "shape":"CUBE", "glb": "levels/common/revcycle-geo.glb"},
    "launcher":         {"label":"Launcher",             "cat":"Platforms", "ag":"floating-launcher-ag.go", "nav_safe":True,  "needs_path":False, "needs_sync":False, "needs_notice_dist":False, "color":(0.9,0.6,0.1,1.0), "shape":"CONE", "glb": "levels/common/floating-launcher-lod0.glb"},
    "warpgate":         {"label":"Warp Gate",            "cat":"Platforms", "ag":"warpgate-ag.go",          "nav_safe":True,  "needs_path":False, "needs_sync":False, "needs_notice_dist":False, "color":(0.3,0.8,0.9,1.0), "shape":"CIRCLE", "glb": "levels/common/warpgate-lod0.glb"},
    # ---- OBJECTS / INTERACTABLES ----
    "cavecrystal":      {"label":"Cave Crystal",         "cat":"Objects",   "ag":"cavecrystal-ag.go",       "nav_safe":True,  "color":(0.7,0.4,0.9,1.0), "shape":"SPHERE", "glb": "levels/maincave/cavecrystal-lod0.glb"},
    "cavegem":          {"label":"Cave Gem",             "cat":"Objects",   "ag":"cavegem-ag.go",           "nav_safe":True,  "color":(0.8,0.2,0.8,1.0), "shape":"SPHERE"},
    "tntbarrel":        {"label":"TNT Barrel",           "cat":"Objects",   "ag":"tntbarrel-ag.go",         "nav_safe":True,  "needs_path":False, "needs_pathb":False, "is_prop":True,  "ai_type":"prop",             "color":(1.0,0.4,0.0,1.0), "shape":"CUBE", "glb": "levels/common/tntbarrel-lod0.glb"},
    ...
    "spike":            {"label":"Spike",                "cat":"Objects",   "ag":"spike-ag.go",             "nav_safe":True,  "needs_path":False, "needs_pathb":False, "is_prop":True,  "ai_type":"prop",             "color":(0.8,0.2,0.2,1.0), "shape":"CONE", "glb": "levels/common/spike-lod0.glb"},
    ...
    "windmill-one":     {"label":"Windmill",             "cat":"Objects",   "ag":"windmill-one-ag.go",      "nav_safe":True,  "needs_path":False, "needs_pathb":False, "is_prop":True,  "ai_type":"prop",             "color":(0.7,0.7,0.5,1.0), "shape":"CUBE", "glb": "levels/village1/windmill-one-lod0.glb"},
    "ecoclaw":          {"label":"Eco Claw",             "cat":"Objects",   "ag":"ecoclaw-ag.go",           "nav_safe":True,  "needs_path":False, "needs_pathb":False, "is_prop":True,  "ai_type":"prop",             "color":(0.2,0.8,0.3,1.0), "shape":"CUBE", "glb": "levels/common/ecoclaw-lod0.glb"},
    "ecovalve":         {"label":"Eco Valve",            "cat":"Objects",   "ag":"ecovalve-ag.go",          "nav_safe":True,  "needs_path":False, "needs_pathb":False, "is_prop":True,  "ai_type":"prop",             "color":(0.3,0.7,0.3,1.0), "shape":"CUBE", "glb": "levels/common/ecovalve-geo.glb"},
    ...
    "caveelevator":     {"label":"Cave Elevator",        "cat":"Platforms", "tpage_group":"Maincave", "ag":"caveelevator-ag.go",      "nav_safe":True,  "needs_path":True,  "needs_sync":False, "needs_notice_dist":False, "color":(0.5,0.4,0.3,1.0), "shape":"CUBE", "glb": "levels/maincave/caveelevator-lod0.glb"},
    ...
    "oracle":           {"label":"Oracle",               "cat":"NPCs",      "tpage_group":"Village1", "ag":"oracle-ag.go",            "nav_safe":True,  "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"process-drawable", "color":(0.9,0.8,0.5,1.0), "shape":"SPHERE", "glb": "levels/common/oracle-lod0.glb"},
    "minershort":       {"label":"Miner (Short)",        "cat":"NPCs",      "tpage_group":"Village3", "ag":"minershort-ag.go",        "nav_safe":True,  "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"process-drawable", "color":(0.6,0.5,0.3,1.0), "shape":"SPHERE", "glb": "levels/maincave/minershort-lod0.glb"},
    "minertall":        {"label":"Miner (Tall)",         "cat":"NPCs",      "tpage_group":"Village3", "ag":"minertall-ag.go",         "nav_safe":True,  "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"process-drawable", "color":(0.5,0.45,0.3,1.0),"shape":"SPHERE", "glb": "levels/maincave/minertall-lod0.glb"},

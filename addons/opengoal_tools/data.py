...
ENTITY_DEFS = {
    ...
    "babak":            {"label":"Babak (Lurker)",       "cat":"Enemies",   "tpage_group":"Beach",    "ag":"babak-ag.go",             "nav_safe":False, "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"nav-enemy",        "color":(1.0,0.1,0.1,1.0), "shape":"SPHERE", "glb": "levels/beach/babak-lod0-mg.glb"},
    "lurkercrab":       {"label":"Lurker Crab",          "cat":"Enemies",   "tpage_group":"Beach",    "ag":"lurkercrab-ag.go",        "nav_safe":False, "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"nav-enemy",        "color":(0.8,0.4,0.0,1.0), "shape":"SPHERE", "glb": "levels/beach/lurkercrab-lod0-mg.glb"},
    "lurkerpuppy":      {"label":"Lurker Puppy",         "cat":"Enemies",   "tpage_group":"Beach",    "ag":"lurkerpuppy-ag.go",       "nav_safe":False, "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"nav-enemy",        "color":(0.9,0.5,0.1,1.0), "shape":"SPHERE", "glb": "levels/beach/lurkerpuppy-lod0-mg.glb"},
    # Jungle group (tpages: 385, 531, 386, 388)
    "hopper":           {"label":"Hopper",               "cat":"Enemies",   "tpage_group":"Jungle",   "ag":"hopper-ag.go",            "nav_safe":False, "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"nav-enemy",        "color":(1.0,0.2,0.1,1.0), "shape":"SPHERE", "glb": "levels/jungle/hopper-lod0-mg.glb"},
    # Swamp group (tpages: 358, 659, 629, 630)
    "swamp-rat":        {"label":"Swamp Rat",            "cat":"Enemies",   "tpage_group":"Swamp",    "ag":"swamp-rat-ag.go",         "nav_safe":False, "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"nav-enemy",        "color":(0.5,0.35,0.1,1.0),"shape":"SPHERE", "glb": "levels/swamp/swamp-rat-lod0-mg.glb"},
    "kermit":           {"label":"Kermit (Lurker)",      "cat":"Enemies",   "tpage_group":"Swamp",    "ag":"kermit-ag.go",            "nav_safe":False, "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"nav-enemy",        "color":(0.2,0.7,0.2,1.0), "shape":"SPHERE", "glb": "levels/swamp/kermit-lod0-mg.glb"},
    # Snow group (tpages: 710, 842, 711, 712)
    "snow-bunny":       {"label":"Snow Bunny",           "cat":"Enemies",   "tpage_group":"Snow",     "ag":"snow-bunny-ag.go",        "nav_safe":False, "needs_path":True,  "needs_pathb":False, "is_prop":False, "ai_type":"nav-enemy",        "color":(0.9,0.9,1.0,1.0), "shape":"SPHERE", "glb": "levels/snow/snow-bunny-lod0-mg.glb"},
    # Sunken group (tpages: 661, 663, 714, 662)
    "double-lurker":    {"label":"Double Lurker",        "cat":"Enemies",   "tpage_group":"Sunken",   "ag":"double-lurker-ag.go",     "nav_safe":False, "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"nav-enemy",        "color":(0.7,0.15,0.15,1.0),"shape":"SPHERE", "glb": ["levels/sunken/double-lurker-lod0-mg.glb", "levels/sunken/double-lurker-top-lod0-mg.glb"]},
    # Misty group (tpages: 516, 521, 518, 520)
    "bonelurker":       {"label":"Bone Lurker",          "cat":"Enemies",   "tpage_group":"Misty",    "ag":"bonelurker-ag.go",        "nav_safe":False, "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"nav-enemy",        "color":(0.8,0.7,0.5,1.0), "shape":"SPHERE", "glb": "levels/misty/bonelurker-lod0-mg.glb"},
    "muse":             {"label":"Muse",                 "cat":"Enemies",   "tpage_group":"Misty",    "ag":"muse-ag.go",              "nav_safe":False, "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"nav-enemy",        "color":(0.9,0.6,0.9,1.0), "shape":"SPHERE", "glb": "levels/misty/muse-lod0-mg.glb"},
    # Maincave group (tpages: 1313, 1315, 1314, 1312)
    "baby-spider":      {"label":"Baby Spider",          "cat":"Enemies",   "tpage_group":"Maincave", "ag":"baby-spider-ag.go",       "nav_safe":False, "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"nav-enemy",        "color":(0.5,0.2,0.1,1.0), "shape":"SPHERE", "glb": "levels/maincave/baby-spider-lod0-mg.glb"},
    # Final group (tpages: varies)
    "green-eco-lurker": {"label":"Green Eco Lurker",     "cat":"Enemies",   "tpage_group":"Final",    "ag":"green-eco-lurker-ag.go",  "nav_safe":False, "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"nav-enemy",        "color":(0.2,0.8,0.2,1.0), "shape":"SPHERE", "glb": "levels/finalboss/green-eco-lurker-lod0-mg.glb"},

    # ---- PROCESS-DRAWABLE ENEMIES — nav_safe=True, no navmesh, may need path ----
    # Grouped by tpage source level.
    # Beach group
    "lurkerworm":       {"label":"Lurker Worm",          "cat":"Enemies",   "tpage_group":"Beach",    "ag":"lurkerworm-ag.go",        "nav_safe":True,  "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"process-drawable", "color":(0.3,0.6,0.1,1.0), "shape":"SPHERE", "glb": "levels/beach/lurkerworm-lod0-mg.glb"},
    # Jungle group
    "junglesnake":      {"label":"Jungle Snake",         "cat":"Enemies",   "tpage_group":"Jungle",   "ag":"junglesnake-ag.go",       "nav_safe":True,  "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"process-drawable", "color":(0.2,0.6,0.2,1.0), "shape":"SPHERE", "glb": "levels/jungle/junglesnake-lod0-mg.glb"},
    # Swamp group
    "swamp-bat":        {"label":"Swamp Bat",            "cat":"Enemies",   "tpage_group":"Swamp",    "ag":"swamp-bat-ag.go",         "nav_safe":True,  "needs_path":True,  "needs_pathb":True,  "is_prop":False, "ai_type":"process-drawable", "color":(0.4,0.2,0.5,1.0), "shape":"SPHERE", "glb": "levels/swamp/swamp-bat-lod0-mg.glb"},
    # Snow group
    "yeti":             {"label":"Yeti",                 "cat":"Enemies",   "tpage_group":"Snow",     "ag":"yeti-ag.go",              "nav_safe":True,  "needs_path":True,  "needs_pathb":False, "is_prop":False, "ai_type":"process-drawable", "color":(0.9,0.95,1.0,1.0),"shape":"SPHERE", "glb": "levels/snow/yeti-lod0-mg.glb"},
    # Sunken group
    "bully":            {"label":"Bully",                "cat":"Enemies",   "tpage_group":"Sunken",   "ag":"bully-ag.go",             "nav_safe":True,  "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"process-drawable", "color":(0.6,0.6,0.9,1.0), "shape":"SPHERE", "glb": "levels/sunken/bully-lod0-mg.glb"},
    "puffer":           {"label":"Puffer",               "cat":"Enemies",   "tpage_group":"Sunken",   "ag":"puffer-ag.go",            "nav_safe":True,  "needs_path":True,  "needs_pathb":False, "is_prop":False, "ai_type":"process-drawable", "color":(0.3,0.4,0.9,1.0), "shape":"SPHERE", "glb": "levels/sunken/puffer-main-lod0-mg.glb"},
    # Ogre group (tpages: 875, 967, 884, 1117)
    "flying-lurker":    {"label":"Flying Lurker",        "cat":"Enemies",   "tpage_group":"Ogre",     "ag":"flying-lurker-ag.go",     "nav_safe":True,  "needs_path":True,  "needs_pathb":False, "is_prop":False, "ai_type":"process-drawable", "color":(0.5,0.2,0.8,1.0), "shape":"SPHERE", "glb": "levels/ogre/flying-lurker-lod0-mg.glb"},
    "plunger-lurker":   {"label":"Plunger Lurker",       "cat":"Enemies",   "tpage_group":"Ogre",     "ag":"plunger-lurker-ag.go",    "nav_safe":True,  "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"process-drawable", "color":(0.8,0.3,0.3,1.0), "shape":"SPHERE", "glb": "levels/ogre/plunger-lurker-lod0-mg.glb"},
    # Maincave group
    "mother-spider":    {"label":"Mother Spider",        "cat":"Enemies",   "tpage_group":"Maincave", "ag":"mother-spider-ag.go",     "nav_safe":True,  "needs_path":True,  "needs_pathb":False, "is_prop":False, "ai_type":"process-drawable", "color":(0.6,0.2,0.1,1.0), "shape":"SPHERE", "glb": "levels/maincave/mother-spider-lod0-mg.glb"},
    "gnawer":           {"label":"Gnawer",               "cat":"Enemies",   "tpage_group":"Maincave", "ag":"gnawer-ag.go",            "nav_safe":True,  "needs_path":True,  "needs_pathb":False, "is_prop":False, "ai_type":"process-drawable", "color":(0.6,0.3,0.1,1.0), "shape":"SPHERE", "glb": "levels/maincave/gnawer-lod0-mg.glb"},
    "driller-lurker":   {"label":"Driller Lurker",       "cat":"Enemies",   "tpage_group":"Maincave", "ag":"driller-lurker-ag.go",    "nav_safe":True,  "needs_path":True,  "needs_pathb":False, "is_prop":False, "ai_type":"process-drawable", "color":(0.5,0.5,0.5,1.0), "shape":"SPHERE", "glb": "levels/maincave/driller-lurker-lod0-mg.glb"},
    "dark-crystal":     {"label":"Dark Crystal",         "cat":"Enemies",   "tpage_group":"Maincave", "ag":"dark-crystal-ag.go",      "nav_safe":True,  "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"process-drawable", "color":(0.4,0.0,0.6,1.0), "shape":"SPHERE", "glb": "levels/maincave/dark-crystal-lod0-mg.glb"},
    # Robocave group (tpages: 1318, 1319, 1317, 1316)
    "cavecrusher":      {"label":"Cave Crusher",         "cat":"Enemies",   "tpage_group":"Robocave", "ag":"cavecrusher-ag.go",       "nav_safe":True,  "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"process-drawable", "color":(0.6,0.6,0.6,1.0), "shape":"SPHERE", "glb": "levels/robocave/cavecrusher-lod0-mg.glb"},
    # Misty group
    "quicksandlurker":  {"label":"Quicksand Lurker",     "cat":"Enemies",   "tpage_group":"Misty",    "ag":"quicksandlurker-ag.go",   "nav_safe":True,  "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"process-drawable", "color":(0.9,0.8,0.3,1.0), "shape":"SPHERE", "glb": "levels/misty/quicksandlurker-lod0-mg.glb"},
    # Village1 group (always loaded — free)
    "ram":              {"label":"Ram",                  "cat":"Enemies",   "tpage_group":"Village1", "ag":"ram-ag.go",               "nav_safe":True,  "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"process-drawable", "color":(0.7,0.4,0.2,1.0), "shape":"SPHERE", "glb": "levels/village1/ram-lod0-mg.glb"},
    ...
    "fireboulder":      {"label":"Fire Boulder",         "cat":"Enemies",   "tpage_group":"Village2", "ag":"fireboulder-ag.go",       "nav_safe":True,  "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"process-drawable", "color":(1.0,0.4,0.0,1.0), "shape":"SPHERE", "glb": "levels/village2/fireboulder-lod0-mg.glb"},
    ...
    "evilplant":        {"label":"Evil Plant (Prop)",    "cat":"Props",     "ag":"evilplant-ag.go",         "nav_safe":True,  "needs_path":False, "needs_pathb":False, "is_prop":True,  "ai_type":"prop",             "color":(0.2,0.5,0.1,1.0), "shape":"SPHERE", "glb": "levels/village1/evilplant-lod0-mg.glb"},
    "dark-plant":       {"label":"Dark Plant (Prop)",    "cat":"Props",     "ag":"dark-plant-ag.go",        "nav_safe":True,  "needs_path":False, "needs_pathb":False, "is_prop":True,  "ai_type":"prop",             "color":(0.3,0.1,0.5,1.0), "shape":"SPHERE", "glb": "levels/rolling/dark-plant-lod0-mg.glb"},

    # ---- BOSSES ----
    "ogreboss":         {"label":"Klaww (Ogre Boss)",    "cat":"Bosses",    "ag":"ogreboss-ag.go",          "nav_safe":True,  "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"process-drawable", "color":(1.0,0.3,0.0,1.0), "shape":"SPHERE", "glb": "levels/ogre/ogreboss-lod0-mg.glb"},
    "plant-boss":       {"label":"Plant Boss",           "cat":"Bosses",    "ag":"plant-boss-ag.go",        "nav_safe":True,  "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"process-drawable", "color":(0.1,0.7,0.1,1.0), "shape":"SPHERE", "glb": "levels/finalboss/plant-boss-main-lod0-mg.glb"},
    "robotboss":        {"label":"Metal Head Boss",      "cat":"Bosses",    "ag":"robotboss-ag.go",         "nav_safe":True,  "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"process-drawable", "color":(0.6,0.6,0.8,1.0), "shape":"SPHERE", "glb": "levels/citadel/robotboss-basic-lod0-mg.glb"},
    # ---- NPCs ----
    ...
    "robber":           {"label":"Robber (Lurker)",      "cat":"NPCs",      "ag":"robber-ag.go",            "nav_safe":True,  "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"process-drawable", "color":(0.3,0.3,0.7,1.0), "shape":"SPHERE", "glb": "levels/rolling/robber-lod0-mg.glb"},
    # ---- PICKUPS ----
    ...
    # Misty group
    "balloonlurker":    {"label":"Balloon Lurker",       "cat":"Enemies",   "tpage_group":"Misty",    "ag":"balloonlurker-ag.go",     "nav_safe":True,  "needs_path":False, "needs_pathb":False, "is_prop":False, "ai_type":"process-drawable", "color":(0.7,0.5,0.8,1.0), "shape":"SPHERE", "glb": "levels/misty/balloonlurker-lod0-mg.glb"},
    # Jungle group
